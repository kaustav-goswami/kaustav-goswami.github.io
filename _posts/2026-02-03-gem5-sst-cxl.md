...
See the paper for more details [iCXL-ClusterSim: Modeling CXL-based Disaggregated Memory Cluster for Pooling and Sharing using gem5 and SST](https://arch.cs.ucdavis.edu/simulation/memory/cxl/2026/05/26/cxl-clustersim.html)
...
- [ ] Implement a CXL cache-coherency paper.
