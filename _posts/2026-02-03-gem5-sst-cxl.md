...
- [x] Implement Back Invalidates (BISnp) with `clflush` on the hosts (WIP on the `dev` branch)
- [x] Use `OneShot` API in SST to improve the performance of the simulation (WIP)
...
- [x] Reimplement memcached with shared memory: [memcached](https://github.com/kaustav-goswami/shared-memcached), [YCSB](https://github.com/kaustav-goswami/YCSB)
